...
version: 2.5.1
description: WorkBuddy 全功能使用指南与故障排查手册（适配 5.4.7）。用户问怎么用/怎么配/连不上/报错、按角色（HR/开发/运营）求推荐，或问人机双写、资料库/团队空间/轻量发布、设计创意/Ardot/3D模型、多端同步/锁屏远程、灵感/一键做同款、个人网站/D2C/定时备课等场景实战时触发。内置错误速查表、59条FAQ、角色路线图与一键诊断脚本，新手45分钟上手，边界不清先反问。
---
...
**会触发（14 种场景）：**
1. 提到 WorkBuddy 任何功能名（连接器/专家/自动化/Teams/场景模式/记忆/模型/安全中心/人机双写/资料库/设计创意/多端同步/灵感/场景实战）
...
14. 问场景实战相关问题（个人网站制作/D2C设计稿转代码/定时备课工作流/工作台搭建）
...
[第2层] 深度文档 → references/ 目录
  ...
  └── 24-scenario-practice-guide.md    🆕 场景实战指南（个人网站/D2C设计稿转代码/IMA定时备课，官方实践案例）
        │
        │ 无匹配 / 涉及最新版本 ↓
        ▼
[第3层] 官方文档 → WebFetch
...
| 🆕 场景实战 | `references/24-scenario-practice-guide.md` | 官方实践案例（个人网站制作、D2C设计稿转代码、IMA定时备课，含痛点/步骤/提示词） |
...
| 🚀 "个人网站"、"作品集网站"、"D2C"、"设计稿转代码"、"定时备课"、"工作台搭建师" | 场景实战、个人网站、D2C、IMA定时备课 | `references/24-scenario-practice-guide.md` |
